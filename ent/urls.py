...
from .views import group_detail, kt_group, groups_edit, text_delete, text_activate, feeds_edit, respite_one_day, respite_three_day, respite_seven_day, respite_start_again, texter, new_user, add_texts, simulate_week, text_set, text_set_detail, new_user_help, text_set_alter, contact_settings
